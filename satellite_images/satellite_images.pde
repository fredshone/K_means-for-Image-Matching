...
int test_images = 50; // input number of test images
int var = 50; // number of result images to return
...
void setup() {
  ...
  for (int i = 0; i < test_images; i ++) {
    String file = "Image_" + (i+1) + ".jpg";
    _test[i] = loadImage(file);
  }
  test = _test;
